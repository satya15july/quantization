...
int main(int argc, char **argv)
{
    ...
    fprintf(stderr, "main.exe modelfile loaded\n");
    if (model == nullptr)
    {
    ...
    // Inference
    fprintf(stderr, "Inference Invoke() --->\n");
    ...
    fprintf(stderr, "Inference load_labels ----->\n");
    // Load Labels
    auto labels = load_labels(labelFile);
    fprintf(stderr, "Inference show  ----->\n");
